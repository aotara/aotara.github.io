...
[T1] **Joint Nature Conservation Committee (JNCC) Invited Talk**: Validating seabird behaviour inferred from hidden Markov models to inform conservation. (July 2023, online)<br />
...
[T7] **Mathematical Biology Group Seminar**: Understanding at-sea behaviour of tern using hidden Markov models. (June 2022, Edinburgh)<br />
